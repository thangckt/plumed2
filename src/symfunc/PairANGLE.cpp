...
class PairANGLE : public ActionShortcut {
public:
...
PairANGLE::PairANGLE(const ActionOptions& ao):
Action(ao),
ActionShortcut(ao)
{
  // Create the matrices
  ...
  readInputLine( getShortcutLabel() + "_smac: MATHEVAL ARG1=" + getShortcutLabel() + "_ksum.n ARG2=" + getShortcutLabel() + "_ksum.d FUNC=x/y PERIODIC=NO");
